...
<!-- Sidebar -->
<aside class="w-64 bg-surface-container flex flex-col hidden md:flex flex-shrink-0 border-r border-surface-variant shadow-[0px_4px_20px_rgba(0,0,0,0.05)]">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        <a class="flex items-center gap-3 px-4 py-3 rounded-lg text-on-surface-variant hover:bg-surface-container-high transition-colors" href="${pageContext.request.contextPath}/admin/dashboard">
            ...
            <span class="font-label-bold text-label-bold">Bảng điều khiển</span>
        </a>
        <a class="flex items-center gap-3 px-4 py-3 rounded-lg bg-primary-container text-on-primary-container" href="${pageContext.request.contextPath}/admin/products">
