                    ...
                    <div class="bg-surface-container-lowest rounded-xl shadow-sm border border-outline-variant p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="number" name="weightGram" value="${product != null && product.weightGram != null ? product.weightGram : '500'}" required min="1" step="1" placeholder="VD: 500 hoặc 1000"
