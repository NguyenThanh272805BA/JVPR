                                    ...
                                    <c:choose>
                                        ...
                                        <c:when test="${order.status == 'FAILED'}">
                                            <div class="p-4 rounded-xl bg-rose-50 border border-rose-200 text-rose-800 text-xs space-y-2">
                                                ...
                                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 text-[11px] text-rose-900/80 bg-white/70 p-3 rounded-lg border border-rose-100">
                                                    <div>
                                                        <span class="text-slate-500 block">Lý do từ Shipper:</span>
                                                ...
                                                <p class="text-[11px] text-rose-700 mt-1 flex items-center gap-1">
                                                    ...
                                                    Shipper hoặc CSKH Fruitables sẽ liên hệ lại qua số điện thoại để hỗ trợ giao lại hoa quả tươi.
                                                </p>
                                            </div>
                                        </c:when>
                                        <c:when test="${order.status == 'RETURNED'}">
                                            <div class="p-4 rounded-xl bg-purple-50 border border-purple-200 text-purple-700 text-xs flex items-center gap-3">
                                                ...
                                                <div>
                                                    <div class="font-bold text-sm text-purple-900">Đơn hàng đã hoàn kho</div>
                                                    <p class="mt-0.5 text-[11px] text-purple-700">Đơn hàng đã được chuyển hoàn về kho bảo quản lạnh của Fruitables. Quý khách vui lòng liên hệ CSKH nếu có thắc mắc.</p>
                                                </div>
                                            </div>
                                        </c:when>
                                        <c:otherwise>
